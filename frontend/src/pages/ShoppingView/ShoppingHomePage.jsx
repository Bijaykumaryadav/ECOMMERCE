...
import bannerOne from "../../assets/home/homepage1.webp";
import bannerTwo from "../../assets/home/homepage2.webp";
import bannerThree from "../../assets/home/homepage3.webp";
import {
  Airplay,
  BabyIcon,
  ChevronLeftIcon,
      ...
      <div className="relative w-full h-[600px] overflow-hidden">
        {staticBanners.map((slide, index) => (
          <img
            ...
            } absolute top-0 left-0 w-full h-full object-full transition-opacity duration-1000`}
          />
        ))}
        <Button
          variant="outline"
          ...
          className="absolute top-1/2 left-4 transform -translate-y-1/2 bg-white/80 text-foreground bg-background"
        >
        ...
        <Button
          ...
          className="absolute top-1/2 right-4 transform -translate-y-1/2 bg-white/80 text-foreground bg-background"
        >
