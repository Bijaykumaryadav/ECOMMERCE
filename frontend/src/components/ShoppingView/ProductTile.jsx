    ...
    <Card className="w-full max-w-sm mx-auto">
      <div>
        <div className="relative">
          ...
          {
            product?.salePrice > 0 ?
            <Badge className="absolute top-2 left-2 bg-red-500 hover:bg-red-600">Sales</Badge> :
            null
          }
        </div>
        <CardContent className="p-4">
          ...
          <div className="flex justify-between items-center mb-2">
            ...
            <span className="text-sm text-muted-forground">{brandOptionsMap[product?.brand]}</span>
          </div >
          <div className="flex justify-between items-center mb-2">
